...
func ToResource(r *db.Row) (*pb.Door, error) {
	var res pb.Door
...
func (r Resources) Get(name string) (*pb.Door, error) {
...
func (r Resources) Update(res *pb.Door) (*pb.Door, error) {
...
func (r Resources) Create(res *pb.Door) (*pb.Door, error) {
